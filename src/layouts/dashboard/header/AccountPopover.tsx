...
// routes
import { PATH_AUTH, PATH_DASHBOARD, PATH_HOME, PATH_PROFILE } from '../../../routes/paths';
// auth
      ...
      >
        ...
        >
          ...
          <Button
            ...
            sx={{ borderColor: '#2C2F40', p: 2 }}
            onClick={() => {
              handleClickItem(PATH_PROFILE.mySubscriptions);
            }}
          >
            <Stack direction="row" sx={{ width: '100%' }} gap={2} alignItems="center">
              <Stack
                ...
                justifyContent="center"
              >
                <SvgColor src="/assets/subscriptions.svg" color="white" />
              </Stack>
              <Typography variant="h5" fontWeight={700} color="text.secondary">
                My Subscriptions
              </Typography>
