...
import CanceledClientsPageTable from './canceled_clients_page/CanceledClientsPageTable';

const tableData: IAdminCanceledClientRowDataType[] = [
  {
    name: 'AAA',
    discordName: 'VVV',
    endDate: new Date(),
      ...
      <Box sx={{ color: 'grey.200', backgroundColor: '#141A36', borderRadius: 1, p: 2, mb: 2 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          <Stack direction="row" gap={2} alignItems="center">
            <Typography variant="h6">Canceled Clients Details</Typography>
          </Stack>
        ...
        <CanceledClientsPageTable tableData={tableData} />
      </Box>
    </Box>
  );
}

export default CanceledClientsPage;
