...
const TABLE_HEAD = [
  ...
  { id: 'frequencyPayment', label: 'Frequency Payment', align: 'center' },
  { id: 'paid', label: 'Paid', align: 'center' },
  { id: 'stillToBePaid', label: 'Still to be paid', align: 'center' },
  { id: 'willPayAmount', label: 'Will pay this month', align: 'center' },
...
interface IClientsPageTable {
  tableData: IAdminClientRowDataType[];
}

function ClientsPageTable({ tableData }: IClientsPageTable) {
  const {
    dense,
    page,
    order,
              ...
              {dataFiltered
                ...
                .map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell sx={{ borderRight: 1, borderColor: '#dbdaf41a' }} align="center">
                      {row.frequencyPayment}
                    </TableCell>
                    <TableCell sx={{ borderRight: 1, borderColor: '#dbdaf41a' }} align="center">
                      <PaidField paid={row.paid} />
                    </TableCell>
                    <TableCell sx={{ borderRight: 1, borderColor: '#dbdaf41a' }} align="center">
                      <StillPaidField stillToBePaid={row.stillToBePaid} />
                    </TableCell>
                    <TableCell sx={{ borderRight: 1, borderColor: '#dbdaf41a' }} align="center">
                      {row.willPayAmount} $
                    </TableCell>
...
export default ClientsPageTable;
...
function applyFilter({
  ...
  inputData: IAdminClientRowDataType[];
